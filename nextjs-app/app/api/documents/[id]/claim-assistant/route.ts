...
export async function GET(request: NextRequest, context: RouteContext) {
  try {
    ...
    const path = withQuery(`/documents/${context.params.id}/claim-assistant`, {
      user_id: userId,
    ...
    const message = error instanceof Error ? error.message : 'Failed to fetch claim assistant payload'
